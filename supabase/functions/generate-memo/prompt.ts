...
10. Section-specific guidance:
    ...
    - Never output role notes such as "Left Lead" in the visible memo. Use the inferred role only to place banks under the correct headings.
    ...
    - Series naming: preserve the exact series naming, spacing, and lettering used in the source document across all sections. If the source shows "2026 C", keep "2026 C"; if it shows "2026C", keep "2026C". Do not normalize away suffix letters or change spacing conventions.
